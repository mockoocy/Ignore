...
class ignoreParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ignoreParser#argumentList.
    def enterArgumentList(self, ctx:ignoreParser.ArgumentListContext):
        pass

    # Exit a parse tree produced by ignoreParser#argumentList.
    def exitArgumentList(self, ctx:ignoreParser.ArgumentListContext):
        pass
    ...
    # Enter a parse tree produced by ignoreParser#var_assign.
    def enterVar_assign(self, ctx:ignoreParser.Var_assignContext):
        pass

    # Exit a parse tree produced by ignoreParser#var_assign.
    def exitVar_assign(self, ctx:ignoreParser.Var_assignContext):
        pass


    # Enter a parse tree produced by ignoreParser#while_loop.
    def enterWhile_loop(self, ctx:ignoreParser.While_loopContext):
        pass

    # Exit a parse tree produced by ignoreParser#while_loop.
    def exitWhile_loop(self, ctx:ignoreParser.While_loopContext):
        pass


    # Enter a parse tree produced by ignoreParser#for_loop.
    def enterFor_loop(self, ctx:ignoreParser.For_loopContext):
        pass

    # Exit a parse tree produced by ignoreParser#for_loop.
    def exitFor_loop(self, ctx:ignoreParser.For_loopContext):
        pass


    # Enter a parse tree produced by ignoreParser#loop_condition.
    def enterLoop_condition(self, ctx:ignoreParser.Loop_conditionContext):
        pass

    # Exit a parse tree produced by ignoreParser#loop_condition.
    def exitLoop_condition(self, ctx:ignoreParser.Loop_conditionContext):
        pass
